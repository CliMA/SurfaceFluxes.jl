...
- **Roughness Sublayer Corrections**: Optional corrections for enhanced turbulent exchange above rough surfaces (forests, urban canopies) via the [Physick & Garratt (1995)](https://doi.org/10.1007/BF00715710) and [Harman & Finnigan (2007)](https://doi.org/10.1007/s10546-006-9145-6) RSL parameterizations.
