...
\end{equation}
```
where $\zeta_0 = \frac{z_{0m}}{L}$ is the stability parameter at the roughness height $z_{0m}$.
...
For unstable conditions, the functions follow the Dyer-Hicks form ([Nishizawa & Kitamura 2018](https://doi.org/10.1029/2018MS001534), Eqs. A1-A2 for $L < 0$), modified to ensure continuity with the neutral Prandtl number $\text{Pr}_0$ at $\zeta = 0$:
