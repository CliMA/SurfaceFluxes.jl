...
display(Plots.plot(u_i / u_star, Z, m = :sq, label = "No-RSL"))
display(Plots.plot!(u_i_canopy ./ u_star, Z, m = :o, label = "RSL"))
display(
    Plots.plot!(;
...
# display(Plots.plot(kΔθ / θ_star,Z, m = :sq, label="No-RSL"))
# display(Plots.plot!(kΔθ_canopy ,Z, m = :o, label="RSL"))
# display(Plots.plot!(;
